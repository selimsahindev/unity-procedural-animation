...
public class SpiderProceduralAnimation : MonoBehaviour
{
    ...
    [SerializeField] int smoothness = 8;
    [SerializeField] float stepHeight = 0.15f;
    [SerializeField] bool bodyOrientation = true;
    ...
    {
        // Prevent spring movement on X axis
    ...
    private Vector2[] MatchToSurfaceFromAbove(Vector2 point, float halfRange, Vector2 up)
    {
